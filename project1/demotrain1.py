...
df=pd.read_csv('demopre.csv')[20:].sample(frac=1,replace=True)
...
df1=df[['SMA','WMA','STCK','MOM','LWR','CCI','TREND']]
...
# df_scaled = pd.DataFrame(df_scaled, columns=['SMA','WMA','STCK','MOM','LWR','CCI'])
# X=df_scaled.values
