...
def showcheck():
    ...
    b2=Button(f5,text="Prediction",font="Verdana 10 bold",command=process1)
    b2.pack(pady=1)
    ...
    lb1.pack(pady=10,padx=5,side='top')
    b3=Button(f1,text="Show Accuracies (Continuous)",font="Verdana 10 bold",command=plot1)
    b3.pack(pady=5,side='top')
    b3=Button(f1,text="Show Accuracies (Binary)",font="Verdana 10 bold",command=plot2)
    b3.pack(pady=5,side='top')
...
if __name__=="__main__":
    ...
    l.place(x=50,y=50)
    l2=Label(f,text="Username:",font="Verdana 10 bold",bg='white')
    ...
    l3=Label(f,text="Password:",font="Verdana 10 bold",bg='white')
